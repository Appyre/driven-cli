...
var debug         = require('debug')('driven-cli:cli/index');
...
function clientId() {
  ...
  var configStore = new ConfigStore('driven-cli');
...
module.exports = function(options) {
  ...
  var cli = new CLI({
    ...
    name: options.cli ? options.cli.name : 'driven',
    root: options.cli ? options.cli.root : path.resolve(__dirname, '..', '..'),
    npmPackage: options.cli ? options.cli.npmPackage : 'driven-cli'
  });
